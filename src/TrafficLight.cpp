...
void TrafficLight::cycleThroughPhases()
{
    ...
    std::random_device ranum;
    std::mt19937 rng(ranum());
    std::uniform_int_distribution<std::mt19937::result_type> dist(4,6); // Generated random value between 4 and 6 seconds
    float cycleTime = dist(rng);
